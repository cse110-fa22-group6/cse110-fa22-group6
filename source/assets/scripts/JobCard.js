  ...
  set data (data) {
    ...
    shadow_article.innerHTML = `
      ...
      <div class="grid-container">
        ...
        <!--       Trash/Pencil Icons -->
        <div class="grid-4">
        <input id="delete-icon" class="delete-icon" type="image" src="/source/assets/images/trash-solid.svg" />
        <input id="edit-icon" class="edit-icon" type="image" src="/source/assets/images/pen-solid.svg" />
        </div>
      </div>
